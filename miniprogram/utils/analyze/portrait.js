...
var TEMP = {
  比肩: { name: '自立', pol: '正', lbl: '果断自强、执行力强', rbl: '爱面子、据理力争',
  ...
  食神: { name: '从容', pol: '正', lbl: '温和善良、乐于奉献', rbl: '好逸恶劳、想多做少',
          desc: '温和斯文、思维细腻，宽容善良、乐于奉献，人缘好、有人文情怀，生活里自带一份福气与从容；只是容易爱幻想、想得多做得少，自尊心强时不肯放下架子，日子舒坦了也容易好逸恶劳。' },
  伤官: { name: '锋芒', pol: '偏', lbl: '才华横溢、追求完美', rbl: '恃才傲物、自律性差',
  ...
  正官: { name: '自律', pol: '正', lbl: '稳健自律、责任心强', rbl: '悲观多虑、不善变通',
  ...
  正印: { name: '宽厚', pol: '正', lbl: '仁慈善良、有精神追求', rbl: '依赖性强、行动力差',

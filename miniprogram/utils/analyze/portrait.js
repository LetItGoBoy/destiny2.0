...
var TEMP = {
  比肩: { name: '自立', pol: '正', lbl: '自主稳健', rbl: '固执较真',
          desc: '有主见、先想清楚再动，自控有分寸、不盲从；执行力强、能扛事，节奏稳不冒进。重平等、重边界，不爱欠人情、不喜被硬压，守得住自己的付出与积累。易偏：固执、接受新意见慢、启动慢；被压时沉默抵抗、不愿服软；对公平和被占便宜敏感，爱暗中较劲。' },
  劫财: { name: '果敢', pol: '偏', lbl: '敢闯仗义', rbl: '冲动破耗',
          desc: '反应快、胜负心强、敢冒险；执行果断、爆发力足，能动就动、不怕硬碰硬；讲义气、重朋友、愿出头，资源来去快、不计较一时得失。易偏：容易上头、先动后想、用力过猛；语气冲、情绪上来说重话；为人情冲动替人扛事，冲动花费、轻财重义。' },
  食神: { name: '从容', pol: '正', lbl: '温和有福', rbl: '安逸拖延',
          desc: '温和松弛、知足重感受，顺其自然；说话柔和、会缓和气氛、让人舒服；做事稳缓、持续输出，擅长把能力变成服务、内容与口碑；厚道宽和、好相处。易偏：易安逸、动力不足，遇强竞争不主动；话说得软、问题不愿讲透；心软边界不硬，图舒服易拖延、降要求。' },
  伤官: { name: '锋芒', pol: '偏', lbl: '才华锐进', rbl: '锋芒招怨',
          desc: '聪明有料、反应快、爱看出问题本质；表达强、观点犀利、敢说真话；有创造力和突破力，敢打破旧方式，靠能力、技术、表达出头；重欣赏、重自由。易偏：易骄傲、自我判断过强；说话不留余地、语气锋利让人被冒犯；不服安排、挑战权威，合作成本高，易招是非。' },
  偏财: { name: '灵活', pol: '偏', lbl: '机变豪爽', rbl: '散漫高估',
          desc: '机会感强、眼光灵活、善于在变化中找收益；爽快直接、会谈资源合作；敢试敢投、灵活切换；豪爽量大、就事论事，能把关系和事分开看，重人脉渠道资金。易偏：易高估机会、判断偏乐观、押太大；口头大方、承诺偏快；边界松手头松，钱财进出快、留存不稳。' },
  正财: { name: '务实', pol: '正', lbl: '踏实可靠', rbl: '保守计较',
          desc: '现实感强、重稳定与确定回报，喜欢可算、可持续的结果；讲实际、重效率、表达直接；踏实本分、按计划推进，适合长期经营、慢慢积累；重责任承诺、边界清楚、会管钱守成。易偏：偏保守、变化感不足、一板一眼；显得不够圆滑；太在意付出回报对等，易被认为计较。' },
  七杀: { name: '开拓', pol: '偏', lbl: '果决担当', rbl: '紧绷过激',
          desc: '危机感强、警觉性高、重结果与强弱，善于预判风险；说话有力度、敢指出问题；果断敢冲、敢担事、能处理难题，遇压力反被激发；欣赏强者、重实力气场，擅长在复杂局面抢出空间。易偏：易紧绷多疑、把普通问题看成威胁；说话太硬给人压力；急躁过猛、做事过头，约束不足易惹是非。' },
  正官: { name: '自律', pol: '正', lbl: '端正负责', rbl: '拘谨多虑',
          desc: '重秩序、身份、名分与责任，重社会认可，走正式合规的判断；温和得体、有分寸、讲场合；稳重负责、按流程推进，愿担正式角色，做事讲标准、讲交代、讲结果。易偏：顾虑评价、怕越界、太在意别人看法；说话太稳、不敢表达真实不满；被流程身份束缚、突破力不足。' },
  偏印: { name: '钻研', pol: '偏', lbl: '专精独到', rbl: '多思孤僻',
          desc: '独立判断、善筛选信息、爱自建一套理解，靠非标准专长、技术、研究或特殊经验打开局面；话少含蓄、点到为止；边界感强、精神空间需求高，重深度与独特理解。易偏：多疑多思、想太深、把简单事复杂化；话里带刺、让人猜不透；多思少动、想一步到位迟迟不开始，易显孤僻。' },
  正印: { name: '宽厚', pol: '正', lbl: '仁厚稳重', rbl: '依赖迟缓',
          desc: '走正统路径、重基础与体系学习、重长期积累，信善意与经验，先接受再消化；温和有礼、谦虚愿听；稳妥先准备、按正规路径推进，重安全感与持续，适合在平台体系中成长；包容照顾、给人安全感。易偏：依赖既有框架、反应偏慢、太在意体面认可；易假客气、藏真实态度；准备过多、怕离舒适区，开拓力不足。' }
};
...
function build(chart, opts) {
  ...
  if (lnGan) {
    ...
    arr.slice(0, 2).forEach(function (it, idx) {
      var t = TEMP[it.god] || { name: it.god, pol: '', lbl: '', rbl: '', desc: '' };
      list.push({
        god: it.god, name: t.name, pol: t.pol, lbl: t.lbl, rbl: t.rbl, desc: t.desc, cls: it.cls,
